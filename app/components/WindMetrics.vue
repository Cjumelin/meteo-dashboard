<template>
  <div class="relative">
    <CardSkeleton
      ...
      class="p-6 md:p-8 text-center relative weather-low"
    />

    <Card
      v-else
      :variant="getCardVariant(Object.values(WindIntensity).indexOf(wind.intensity))"
    ...
    >
      ...
      <div class="self-center text-center pt-4">
        <span
          class="block text-2xl transition-transform duration-300 ease-[var(--ease-weather)]"
